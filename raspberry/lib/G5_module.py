...
def read_data(dstr):
	...
	## temperature ##
        temp = (int(data_slice[48] + data_slice[49] + data_slice[50] + data_slice[51], 16) / 10)

        ## humidity ##
        hum = (int(data_slice[52] + data_slice[53] + data_slice[54] + data_slice[55], 16) / 10)


    return (1, pm1, pm25, pm10, temp, hum)
